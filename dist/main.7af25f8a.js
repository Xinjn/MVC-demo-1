...
},{}],"ma2U":[function(require,module,exports) {
...
},{"process":"ma2U"}],"US5u":[function(require,module,exports) {
"use strict";
...
var $number = (0, _jquery.default)('#number'); //获取数字
// 初始化n,把n提前存储到localStorage

var n = localStorage.getItem('n');
$number.text(n || 100); //绑定事件（加减乘除）
...
var $tabContent = (0, _jquery.default)("#app2 .tab-content"); // //我们现在需要监听li，li没加名字怎么监听？
// // jQuery 提供了监听子元素的事件！
// //也叫做事件委托！（不监听子元素监听父元素）
...
$tabBar.on('click', 'li', function (e) {
  // console.log(e.currentTarget)//打印出点击目标;target/currentTarget各自尝试，不对就用另一个，点击后最终必须都是是<li></li>才可以
  // 永远不要使用DOM
  var $li = (0, _jquery.default)(e.currentTarget); //获取点击目标

  $li.addClass('selected').siblings().removeClass('selected');
  var index = $li.index(); //获取点击目标索引(获取排行老几)

  console.log(index); //永远不要用直接操作CSS的API：css/show/hide//要用addClass/removeClass
  //这种方式叫做 样式与行为分离

  $tabContent.children().eq(index).addClass('active') // 拓展eq()等于第几个的意思.添加class类名
  .siblings().removeClass('active'); //其他兄弟则删除class类名
}); //刚开始什么也不显示，使刚开始为选择状态
...
//# sourceMappingURL=main.7af25f8a.js.map